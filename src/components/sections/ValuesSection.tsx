        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div 
              ...
              className="flex flex-col items-center text-center p-6 rounded-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer border border-white/10 bg-white/[0.02] backdrop-blur-sm"
            >
